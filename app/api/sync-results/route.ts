...
const JOGOS_BOLAO: Record<string, number> = {
  ...
  "Alemanha-Curaçao": 9, "Costa do Marfim-Equador": 10, "Holanda-Japão": 11,
  ...
  "Alemanha-Costa do Marfim": 33, "Equador-Curaçao": 34, "Holanda-Suécia": 35,
  ...
  "Tunísia-Holanda": 60, "Egito-Irã": 61, "Nova Zelândia-Bélgica": 62,
